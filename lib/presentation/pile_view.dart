...
export 'slot_placeholder.dart' show foundationSlotMarkerKey, parkSlotMarkerKey;
...
class PileView extends StatelessWidget {
  ...
  /// An empty pile: delegates to [SlotPlaceholder] for the outlined slot and
  /// role marker, forwarding the pile tap (used by the stock's recycle tap).
  Widget _placeholder() =>
      SlotPlaceholder(kind: pile.kind, cardSize: cardSize, onTap: onPileTap);
